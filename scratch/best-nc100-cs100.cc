...
int main (int argc, char *argv[])
{
  ...
  ccnxHelper.SetContentStore ("ns3::ndn::cs::Lru","MaxSize", "100");
 ...
 // consumerHelper.Install (Node50);
  ...
  AggregateTracer = ndn::L3AggregateTracer::InstallAll ("data-bestroute/nc100-cs100/aggregate-trace.txt", Seconds (0.5));
 
  boost::tuple< boost::shared_ptr<std::ostream>, std::list<Ptr<ndn::L3RateTracer> > >
  L3RateTracer = ndn::L3RateTracer::InstallAll ("data-bestroute/nc100-cs100/rate-trace.txt", Seconds (0.5));
 
  boost::tuple< boost::shared_ptr<std::ostream>, std::list<Ptr<ndn::CsTracer> > >
  aggTracers = ndn::CsTracer::InstallAll ("data-bestroute/nc100-cs100/cs-trace.txt", Seconds (1));
 
  boost::tuple< boost::shared_ptr<std::ostream>, std::list<Ptr<ndn::AppDelayTracer> > >
  delayTracer = ndn::AppDelayTracer::InstallAll ("data-bestroute/nc100-cs100/app-delays-trace.txt");
