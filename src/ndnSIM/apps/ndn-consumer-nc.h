...
//added by zfx
  struct SeqArrived
  {
    SeqArrived (uint32_t _seq, uint32_t _coef) : seq (_seq), coef (_coef) { }

    uint32_t seq;
    uint32_t coef;
  };
  
 struct SeqArrivedContainer :
    public boost::multi_index::multi_index_container<
    SeqArrived,
    boost::multi_index::indexed_by<
      boost::multi_index::ordered_unique<
        boost::multi_index::tag<i_seq>,
        boost::multi_index::member<SeqArrived, uint32_t, &SeqArrived::seq>
        >,
      boost::multi_index::ordered_non_unique<
        boost::multi_index::tag<i_coef>,
        boost::multi_index::member<SeqArrived, uint32_t, &SeqArrived::coef>
        >
      >
    > { } ;
  SeqArrivedContainer m_arrivedData;          /// added by zfx      
/// @endcond
};
