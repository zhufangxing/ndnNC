        ...
        case HeaderHelper::INTEREST_NDNSIM:
          {
            ...
            //std::cout << "OnInterest()"<<"Name: "<<header->GetName()<<"ndn-l3-protocol.cc line-272"<<std::endl;
            ...
            const::string matchname = "/ndn/" + vod + "/" + nc + "/" + seg;
            header->SetName(Name(matchname));
            ...
            //m_forwardingStrategy->OnInterest (face, header, packet/*original packet*/);
            //end 
