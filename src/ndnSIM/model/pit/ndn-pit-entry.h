...
public:
  ...
  typedef std::set<uint64_t> coef_container; ///< @brief incoming faces container type
  typedef coef_container::iterator coef_iterator;                ///< @brief iterator to incoming faces
  ...
  virtual in_iterator
  AddIncoming (Ptr<Face> face, uint64_t coef);

  virtual coef_iterator
  AddCoef (uint64_t );
  /**
...
protected:
  ...
  coef_container m_coef;  ///< \brief map of nonces that were seen for this prefix
